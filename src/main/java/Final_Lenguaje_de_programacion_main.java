 ...
 * 
 * 1.  Debe simular un inventario del que se descuentan productos comprados.
 * 2. Se consulta la información de estos y se realizan procesos de totalización de una compra.
 * 3. Consulta de información general y específica sobre un producto.
 * 4. Cargar nuevos productos o actualizar los existentes.
 * 
